...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    return get_name(city_a) if distance(city_a, make_city('city', lat, lon)) < distance(city_b, make_city('city', lat, lon)) else get_name(city_b)
...
def count_palindromes(L):
    ...
    2
    """
    return sum([1 for i in L if i.lower() == i.lower()[::-1]])
