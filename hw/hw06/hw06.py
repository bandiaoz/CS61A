...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        return self.cents.cents + max(0, Mint.present_year - self.year - 50)
...
class VendingMachine:
    ...
    def vend(self):
        ...
        if self.funds < self.price:
            ...
            self.funds = 0
            self.stock -= 1
            return f'Here is your {self.commodity} and ${changes} change.'
...
class Player:
    ...
    def debate(self, other):
        "*** YOUR CODE HERE ***"
        succeed = max(0.1, max(0.1, self.popularity / (self.popularity + other.popularity)))
        if random() < succeed:
            self.popularity += 50
        else:
    ...
    def speech(self, other):
        ...
        sub = other.popularity // 10
        self.popularity += add
        self.votes += add
        other.popularity = max(0, other.popularity - sub)
...
class VirFib():
    ...
    def next(self):
        ...
        if self.value == 0:
            ...
            ans = VirFib(self.value + self.previous)
        ans.previous = self.value
        return ans
